...
def lambda_handler(event, context):
    ...
    try:
        ...
        ENDPOINT_NAME = "sms-spam-classifier-mxnet-2021-12-16-21-03-27-036"
        message = body
        test_messages = [body]
        ...
        body = f"""We have received your email sent at {date} with the subject: {subject}. \nHere is a 240 character sample of the email body:{message[:240]}. \n\nThe email was classified as {label} with a {probability*100} confidence percentage"""
        ses.send_email(
            ...
            Source="test@awsemailspamtesting.ml",
        )
